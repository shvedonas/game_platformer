...
public class GameUnitTests
{
    ...
    {
        // Передаем 3 значения здоровья (100, 100, 100) и 1 значение урона (10)
        ...
        Assert.AreEqual(100, d.WitchHealth); // Можно проверить конкретное здоровье
    }
    ...
    {
        // Проверяем отрицательное здоровье для одного из персонажей
